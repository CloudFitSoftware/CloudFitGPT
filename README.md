...
- [ChatGPT_undefined_x64_en-US.msi](https://github.com/lencx/ChatGPT/releases/download/vundefined/ChatGPT_undefined_x64_en-US.msi): Direct download installer
- Use [winget](https://winstall.app/apps/lencx.ChatGPT):
  ...
  winget install --id=lencx.ChatGPT -e --version undefined
  ```

**Note: If the installation path and application name are the same, it will lead to conflict ([#142](https://github.com/lencx/ChatGPT/issues/142#issuecomment-undefined))**

### Mac

- [ChatGPT_undefined_x64.dmg](https://github.com/lencx/ChatGPT/releases/download/vundefined/ChatGPT_undefined_x64.dmg): Direct download installer
- [ChatGPT.app.tar.gz](https://github.com/lencx/ChatGPT/releases/download/vundefined/ChatGPT.app.tar.gz): Download the `.app` installer
- Homebrew \
...
- [chat-gpt_undefined_amd64.deb](https://github.com/lencx/ChatGPT/releases/download/vundefined/chat-gpt_undefined_amd64.deb): Download `.deb` installer, advantage small size, disadvantage poor compatibility
- [chat-gpt_undefined_amd64.AppImage](https://github.com/lencx/ChatGPT/releases/download/vundefined/chat-gpt_undefined_amd64.AppImage): Works reliably, you can try it if `.deb` fails to run
