    ...
    let preferences_menu = Submenu::new(
        ...
        Menu::with_items([
            ...
            CustomMenuItem::new("clear_conf".to_string(), "Clear Config")
                ...
                .into(),
            CustomMenuItem::new("restart".to_string(), "Restart CloudFitGPT")
                .accelerator("CmdOrCtrl+Shift+R")
                .into(),
            MenuItem::Separator.into(),
            CustomMenuItem::new("awesome".to_string(), "Awesome CloudFitGPT")
    ...
    if cfg!(target_os = "macos") {
        SystemTray::new().with_menu(
            SystemTrayMenu::new()
                ...
                .add_item(CustomMenuItem::new("show_core".to_string(), "Show CloudFitGPT"))
                .add_native_item(SystemTrayMenuItem::Separator)
                .add_item(CustomMenuItem::new("quit".to_string(), "Quit CloudFitGPT")),
        )
    } else {
        SystemTray::new().with_menu(
            SystemTrayMenu::new()
